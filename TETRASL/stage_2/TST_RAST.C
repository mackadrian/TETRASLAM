...
int main()
{
	...
	/*Test 6: start*/
	Cnecin();
	plot_bitmap_16(base_16, 176 + 48, 40, playing_field, 303, 10);
	plot_text(base_8, 329 + (48 * 2), 40, font, "C O U N T E R:");
	plot_text(base_8, 329 + (48 * 2), 40 + 8, font, "1 0 0  /  1 0 0");
	plot_bitmap_16(base_16, 176 - 128, 40, I_piece, 61, 1);
	plot_bitmap_16(base_16, 176 - 64, 40, J_piece, 46, 2);
	plot_bitmap_16(base_16, 176 - 128, 40 + 64, L_piece, 46, 2);
	plot_bitmap_16(base_16, 176 - 64, 40 + 64, O_piece, 31, 2);
	plot_bitmap_16(base_16, 176 - 128, 40 + (64 * 2), S_piece, 31, 3);
	plot_bitmap_16(base_16, 176 - 64, 40 + (64 * 2), T_piece, 31, 3);
	plot_bitmap_16(base_16, 176 - 128, 40 + (64 * 3), Z_piece, 31, 3);
